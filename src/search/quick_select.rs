...
fn partition<T>(arr: &mut [T], pivot_idx:usize) -> usize where T: Clone + PartialOrd{
...
*/
pub fn quick_select<T>(arr: &mut [T], n: usize) -> T where T: Clone+PartialOrd {
...
a random generator.
*/
pub fn quick_select_rand<T>(arr: &mut [T], n: usize) -> T where T: Clone+PartialOrd{
...
fn quick_select_impl<T, F>(arr: &mut [T], mut n: usize, mut choose_pivot: F) -> T where T: Clone+PartialOrd, F: FnMut(usize)->usize{
